...
import { Heart, Star, Search, Filter, Loader2, Gamepad2, ChevronLeft, ChevronRight, Rocket } from 'lucide-react'
...
export default function LiveGamesPage() {
  ...
  const loadGames = useCallback(async () => {
    setLoading(true)
    try {
      const params: any = { sort, page, limit: 12, serviceType: 'live' }
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold mb-3">
              <span className="text-accent">라이브게임</span>
            </h1>
            <p className="text-text-secondary">베타 테스트를 거쳐 정식 서비스 중인 게임을 만나보세요</p>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {!loading && (
          <p className="text-sm text-text-secondary mb-6">
            총 <span className="text-text-primary font-semibold">{totalCount}</span>개의 라이브 게임
          </p>
        )}
