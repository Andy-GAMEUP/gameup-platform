...
const DUMMY: SettlementRow[] = [
  // 스타 디펜더
  { id:'1',  company:'testdev', gameTitle:'스타 디펜더',   settledAt:'2026-06-10', periodFrom:'2026-05-01', periodTo:'2026-05-31', revenue:3_820_000, vat:382_000, paybackExpired:95_000,  platformFee:191_000, paymentMethodFee:57_300, baseSettlement:3_189_700, carryover:48_000, paybackComp:32_000, settlementAmount:3_300_700, status:'completed' },
  { id:'2',  company:'testdev', gameTitle:'스타 디펜더',   settledAt:'2026-05-10', periodFrom:'2026-04-01', periodTo:'2026-04-30', revenue:3_510_000, vat:351_000, paybackExpired:71_000,  platformFee:175_500, paymentMethodFee:52_650, baseSettlement:2_930_850, carryover:35_000, paybackComp:28_000, settlementAmount:3_008_850, status:'completed' },
  { id:'3',  company:'testdev', gameTitle:'스타 디펜더',   settledAt:'2026-04-10', periodFrom:'2026-03-01', periodTo:'2026-03-31', revenue:2_990_000, vat:299_000, paybackExpired:60_000,  platformFee:149_500, paymentMethodFee:44_850, baseSettlement:2_496_650, carryover:22_000, paybackComp:19_000, settlementAmount:2_559_650, status:'completed' },
  { id:'4',  company:'testdev', gameTitle:'스타 디펜더',   settledAt:'-',          periodFrom:'2026-06-01', periodTo:'2026-06-30', revenue:1_240_000, vat:124_000, paybackExpired:0,        platformFee:62_000,  paymentMethodFee:18_600, baseSettlement:1_035_400, carryover:0,      paybackComp:0,      settlementAmount:1_035_400, status:'pending'   },
  // 공룡 돌격대
  { id:'5',  company:'testdev', gameTitle:'공룡 돌격대',   settledAt:'2026-06-10', periodFrom:'2026-05-01', periodTo:'2026-05-31', revenue:1_640_000, vat:164_000, paybackExpired:41_000,  platformFee:82_000,  paymentMethodFee:24_600, baseSettlement:1_369_400, carryover:12_000, paybackComp:9_000,  settlementAmount:1_413_400, status:'completed' },
  { id:'6',  company:'testdev', gameTitle:'공룡 돌격대',   settledAt:'2026-05-10', periodFrom:'2026-04-01', periodTo:'2026-04-30', revenue:1_280_000, vat:128_000, paybackExpired:28_000,  platformFee:64_000,  paymentMethodFee:19_200, baseSettlement:1_068_800, carryover:8_000,  paybackComp:6_000,  settlementAmount:1_098_800, status:'completed' },
  { id:'7',  company:'testdev', gameTitle:'공룡 돌격대',   settledAt:'2026-04-10', periodFrom:'2026-03-01', periodTo:'2026-03-31', revenue:980_000,   vat:98_000,  paybackExpired:18_000,  platformFee:49_000,  paymentMethodFee:14_700, baseSettlement:818_300,   carryover:5_000,  paybackComp:4_000,  settlementAmount:837_300,   status:'completed' },
  { id:'8',  company:'testdev', gameTitle:'공룡 돌격대',   settledAt:'-',          periodFrom:'2026-06-01', periodTo:'2026-06-30', revenue:530_000,   vat:53_000,  paybackExpired:0,        platformFee:26_500,  paymentMethodFee:7_950,  baseSettlement:442_550,   carryover:0,      paybackComp:0,      settlementAmount:442_550,   status:'pending'   },
  // 전설의 영웅들
  { id:'9',  company:'testdev', gameTitle:'전설의 영웅들', settledAt:'2026-06-10', periodFrom:'2026-05-01', periodTo:'2026-05-31', revenue:4_700_000, vat:470_000, paybackExpired:112_000, platformFee:235_000, paymentMethodFee:70_500, baseSettlement:3_924_500, carryover:61_000, paybackComp:44_000, settlementAmount:4_053_500, status:'completed' },
  { id:'10', company:'testdev', gameTitle:'전설의 영웅들', settledAt:'2026-05-10', periodFrom:'2026-04-01', periodTo:'2026-04-30', revenue:4_210_000, vat:421_000, paybackExpired:98_000,  platformFee:210_500, paymentMethodFee:63_150, baseSettlement:3_515_350, carryover:52_000, paybackComp:38_000, settlementAmount:3_627_350, status:'completed' },
  { id:'11', company:'testdev', gameTitle:'전설의 영웅들', settledAt:'2026-04-10', periodFrom:'2026-03-01', periodTo:'2026-03-31', revenue:3_850_000, vat:385_000, paybackExpired:82_000,  platformFee:192_500, paymentMethodFee:57_750, baseSettlement:3_214_750, carryover:40_000, paybackComp:30_000, settlementAmount:3_306_750, status:'completed' },
  { id:'12', company:'testdev', gameTitle:'전설의 영웅들', settledAt:'-',          periodFrom:'2026-06-01', periodTo:'2026-06-30', revenue:1_870_000, vat:187_000, paybackExpired:0,        platformFee:93_500,  paymentMethodFee:28_050, baseSettlement:1_561_450, carryover:0,      paybackComp:0,      settlementAmount:1_561_450, status:'pending'   },
  // 픽셀 레이서
  { id:'13', company:'testdev', gameTitle:'픽셀 레이서',   settledAt:'2026-06-10', periodFrom:'2026-05-01', periodTo:'2026-05-31', revenue:2_150_000, vat:215_000, paybackExpired:53_000,  platformFee:107_500, paymentMethodFee:32_250, baseSettlement:1_795_250, carryover:24_000, paybackComp:17_000, settlementAmount:1_855_250, status:'completed' },
  { id:'14', company:'testdev', gameTitle:'픽셀 레이서',   settledAt:'2026-05-10', periodFrom:'2026-04-01', periodTo:'2026-04-30', revenue:1_890_000, vat:189_000, paybackExpired:40_000,  platformFee:94_500,  paymentMethodFee:28_350, baseSettlement:1_578_150, carryover:18_000, paybackComp:13_000, settlementAmount:1_623_150, status:'completed' },
  { id:'15', company:'testdev', gameTitle:'픽셀 레이서',   settledAt:'-',          periodFrom:'2026-06-01', periodTo:'2026-06-30', revenue:760_000,   vat:76_000,  paybackExpired:0,        platformFee:38_000,  paymentMethodFee:11_400, baseSettlement:634_600,   carryover:0,      paybackComp:0,      settlementAmount:634_600,   status:'pending'   },
  // 네온 러너
  { id:'16', company:'testdev', gameTitle:'네온 러너',     settledAt:'2026-06-10', periodFrom:'2026-05-01', periodTo:'2026-05-31', revenue:890_000,   vat:89_000,  paybackExpired:22_000,  platformFee:44_500,  paymentMethodFee:13_350, baseSettlement:743_150,   carryover:7_000,  paybackComp:5_000,  settlementAmount:767_150,   status:'completed' },
  { id:'17', company:'testdev', gameTitle:'네온 러너',     settledAt:'2026-05-10', periodFrom:'2026-04-01', periodTo:'2026-04-30', revenue:720_000,   vat:72_000,  paybackExpired:15_000,  platformFee:36_000,  paymentMethodFee:10_800, baseSettlement:601_200,   carryover:5_000,  paybackComp:4_000,  settlementAmount:617_200,   status:'completed' },
  { id:'18', company:'testdev', gameTitle:'네온 러너',     settledAt:'-',          periodFrom:'2026-06-01', periodTo:'2026-06-30', revenue:310_000,   vat:31_000,  paybackExpired:0,        platformFee:15_500,  paymentMethodFee:4_650,  baseSettlement:258_850,   carryover:0,      paybackComp:0,      settlementAmount:258_850,   status:'pending'   },
  // 던전 어드벤처
  { id:'19', company:'testdev', gameTitle:'던전 어드벤처', settledAt:'2026-06-10', periodFrom:'2026-05-01', periodTo:'2026-05-31', revenue:2_430_000, vat:243_000, paybackExpired:58_000,  platformFee:121_500, paymentMethodFee:36_450, baseSettlement:2_029_050, carryover:28_000, paybackComp:20_000, settlementAmount:2_095_050, status:'completed' },
  { id:'20', company:'testdev', gameTitle:'던전 어드벤처', settledAt:'2026-05-10', periodFrom:'2026-04-01', periodTo:'2026-04-30', revenue:2_110_000, vat:211_000, paybackExpired:44_000,  platformFee:105_500, paymentMethodFee:31_650, baseSettlement:1_761_850, carryover:21_000, paybackComp:15_000, settlementAmount:1_811_850, status:'completed' },
  { id:'21', company:'testdev', gameTitle:'던전 어드벤처', settledAt:'-',          periodFrom:'2026-06-01', periodTo:'2026-06-30', revenue:940_000,   vat:94_000,  paybackExpired:0,        platformFee:47_000,  paymentMethodFee:14_100, baseSettlement:784_900,   carryover:0,      paybackComp:0,      settlementAmount:784_900,   status:'pending'   },
  // 마법사의 탑
  { id:'22', company:'testdev', gameTitle:'마법사의 탑',   settledAt:'2026-06-10', periodFrom:'2026-05-01', periodTo:'2026-05-31', revenue:1_320_000, vat:132_000, paybackExpired:33_000,  platformFee:66_000,  paymentMethodFee:19_800, baseSettlement:1_102_200, carryover:10_000, paybackComp:8_000,  settlementAmount:1_137_200, status:'completed' },
  { id:'23', company:'testdev', gameTitle:'마법사의 탑',   settledAt:'2026-05-10', periodFrom:'2026-04-01', periodTo:'2026-04-30', revenue:1_050_000, vat:105_000, paybackExpired:24_000,  platformFee:52_500,  paymentMethodFee:15_750, baseSettlement:876_750,   carryover:7_000,  paybackComp:5_000,  settlementAmount:902_750,   status:'completed' },
  { id:'24', company:'testdev', gameTitle:'마법사의 탑',   settledAt:'-',          periodFrom:'2026-06-01', periodTo:'2026-06-30', revenue:480_000,   vat:48_000,  paybackExpired:0,        platformFee:24_000,  paymentMethodFee:7_200,  baseSettlement:400_800,   carryover:0,      paybackComp:0,      settlementAmount:400_800,   status:'pending'   },
  // 크리스탈 퀘스트
  { id:'25', company:'testdev', gameTitle:'크리스탈 퀘스트', settledAt:'2026-06-10', periodFrom:'2026-05-01', periodTo:'2026-05-31', revenue:1_780_000, vat:178_000, paybackExpired:44_000, platformFee:89_000,  paymentMethodFee:26_700, baseSettlement:1_486_300, carryover:16_000, paybackComp:11_000, settlementAmount:1_535_300, status:'completed' },
  { id:'26', company:'testdev', gameTitle:'크리스탈 퀘스트', settledAt:'2026-05-10', periodFrom:'2026-04-01', periodTo:'2026-04-30', revenue:1_490_000, vat:149_000, paybackExpired:30_000, platformFee:74_500,  paymentMethodFee:22_350, baseSettlement:1_244_150, carryover:11_000, paybackComp:8_000,  settlementAmount:1_277_150, status:'completed' },
  { id:'27', company:'testdev', gameTitle:'크리스탈 퀘스트', settledAt:'-',          periodFrom:'2026-06-01', periodTo:'2026-06-30', revenue:620_000,   vat:62_000,  paybackExpired:0,       platformFee:31_000,  paymentMethodFee:9_300,  baseSettlement:517_700,   carryover:0,      paybackComp:0,      settlementAmount:517_700,   status:'pending'   },
]
