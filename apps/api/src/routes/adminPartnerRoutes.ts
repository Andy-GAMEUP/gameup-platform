...
import {
  ...
  getDeletedAdminProjects,
  restoreAdminProject,
  deleteAdminProjectLog,
  adminAddTeamMember,
...
router.get('/partner/projects/deleted', requireAdminLevel('super', 'normal'), getDeletedAdminProjects)
...
router.post('/partner/projects/deleted/:id/restore', requireAdminLevel('super'), restoreAdminProject)
router.delete('/partner/projects/deleted/:id', requireAdminLevel('super'), deleteAdminProjectLog)
