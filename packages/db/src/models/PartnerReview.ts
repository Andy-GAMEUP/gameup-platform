...
export interface IPartnerReview extends Document {
  ...
  targetPartnerId?: mongoose.Types.ObjectId
...
const partnerReviewSchema = new Schema<IPartnerReview>(
  {
    ...
    targetMinihomeId: { type: Schema.Types.ObjectId, ref: 'MiniHome' },
    targetPartnerId: { type: Schema.Types.ObjectId, ref: 'Partner' },
...
partnerReviewSchema.index({ targetPartnerId: 1, createdAt: -1 })
